		...
		<view class="container">
			...
			<view style="width: 100%;background-color: white;border-radius:5px;">
				<u-cell-group>
					...
					<u-cell v-if="model.userInfo.role_type != 1 && model.userInfo.auth == 1" title="我的投诉"
						icon="/static/car/met.png" isLink url="/pages/car/taxi/complain/me"></u-cell>
					<u-cell v-if="model.userInfo.role_type == 1" title="投诉处理" isLink
